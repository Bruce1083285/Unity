        ...
        this.show = function () {
            ...
            if (Toast.bgSpriteFrame === undefined) {
                ...
                (function () {
                    ...
                    // cc.loader.load({ 'uuid': 'c72e0f6e-f91a-4ac4-8a41-0606c0a3c46c' },
                    cc.loader.loadRes('Textures/bg_heidi',
                        function (error, result) {
                            ...
                            Toast.bgSpriteFrame.insetTop = 15;
                            Toast.bgSpriteFrame.insetBottom = 15;
                            Toast.bgSpriteFrame.insetLeft = 15;
                            Toast.bgSpriteFrame.insetRight = 15;
                            //加载完再调用
                            self.show();
                        })
                })();
            ...
            bgNode.color = new cc.Color(cc.Color.BLACK);
            // 背景图片透明度
            bgNode.opacity = 255;
            ...
            //背景图片与文本内容的间距
            var hPadding = textLabel.fontSize / 4;
            var vPadding = 20;
            ...
            // 当文本宽度过长时，设置为自动换行格式
            if (_text&&( _text.length * textLabel.fontSize > width / 3)) {
            ...
            var action = cc.sequence(cc.delayTime(_duration), cc.fadeOut(0.3), finished);
